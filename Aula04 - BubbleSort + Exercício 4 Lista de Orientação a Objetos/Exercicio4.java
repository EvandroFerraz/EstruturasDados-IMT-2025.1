...
class ListaRecomendacoes<T> {
    ...
    public T obter(int indice) {
        ...
        throw new IndexOutOfBoundsException("Indice fora dos limites."); // Exceção para índice inválido
    }
...
class RecomendadorAI {
    ...
    public void exibirRecomendacoes() {
        System.out.println("Recomendacoes de Produtos:");
...
public class Exercicio4 {
    public static void main(String[] args) {
        ...
        if (args.length > 0) {
            ...
            System.out.println("\nApos remover a primeira recomendacao:");
