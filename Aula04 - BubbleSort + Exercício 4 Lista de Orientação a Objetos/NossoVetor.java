    ...
    public void bubbleSort(){
        ...
        for(int i = 1; i < vetor.length; i++){
            for(int j = 0; j < vetor.length-i; j++){
                ...
                // 1.2 iteração: j = 1, vetor[j] = 72
                    // vetor = [8, 64, 72, 12, 36]
                // 1.3 iteração: j = 2, vetor[j] = 72
                    // vetor = [8, 64, 12, 72, 36]
                // 1.4 iteração: j = 3, vetor[j] = 72
                    // vetor = [8, 64, 12, 36, 72]
                // 2.1 iteração: j = 0, vetor[j] = 8
                // 2.2 iteração: j = 1, vetor[j] = 64
                    // vetor = [8, 12, 64, 36, 72]
                // 2.3 iteração: j = 2, vetor[j] = 64
                    // vetor = [8, 12, 36, 64, 72]
                // 3.1 iteração: j = 0, vetor[j] = 8
                // 3.2 iteração: j = 1, vetor[j] = 12
                // 4.1 iteração: j = 0, vetor[j] = 8
                    // Ordenação concluída: vetor = [8, 12, 36, 64, 72]
                // 1 Laço: teria n iterações
                // 2 Laço: n-i iterações, n-i simplificado para n
                // Complexidade: n^2, uma complexidade quadrática.
